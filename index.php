...
function translit($text){
    ...
    $result = strtr($text, $trans_symbols);
    echo $result;
}

translit('Объявить массив, индексами которого являются буквы русского языка');
...
function trans_url($text){
    ...
    $tmp = strtr($text, $trans_symbols);
    $result = explode(' ', $tmp);
    return implode('_', $result);

}

echo trans_url('Объявить массив, индексами которого являются буквы русского языка');